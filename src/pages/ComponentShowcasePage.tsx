    ...
    <div className="min-h-screen px-6 py-10 md:px-12">
      ...
      <div className="flex flex-col gap-10">
        ...
        <Section title="Word Card">
          <WordCard word={{ id: '1', bankName: 'showcase', fileId: '', kanji: '食', reading: 'たべる', meaning: '먹다', jlptLevel: 'N5' }} />
          <WordCard word={{ id: '2', bankName: 'showcase', fileId: '', kanji: '経済', reading: 'けいざい', meaning: '경제', jlptLevel: 'N2' }} />
        </Section>
